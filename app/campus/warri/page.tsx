    ...
    <main>
      ...
      <section className={styles.aboutSection}>
        <div className={styles.container}>
          <h2 className={styles.subtitle}>About Warri Campus</h2>
          <p className={styles.aboutText}>This is a temporary description of the Warri Campus. Located in the vibrant Delta State, this campus is committed to delivering top-notch skill acquisition programs. Stay tuned for more details about our facilities, courses, and community impact!</p>
        </div>
      </section>
