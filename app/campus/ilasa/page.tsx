    ...
    <main>
      ...
      <section className={styles.aboutSection}>
        <div className={styles.container}>
          <h2 className={styles.subtitle}>About Ilasa Campus</h2>
          <p className={styles.aboutText}>This is a temporary description of the Ilasa Campus. Located in a vibrant part of Lagos, this campus is committed to delivering top-notch skill acquisition programs. Stay tuned for more details about our facilities, courses, and community impact!</p>
        </div>
      </section>
