    ...
    <main>
      ...
      <section className={styles.aboutSection}>
        <div className={styles.container}>
          <h2 className={styles.subtitle}>About Kano Campus</h2>
          <p className={styles.aboutText}>This is a temporary description of the Kano Campus. Located in the vibrant city of Kano, this campus is committed to delivering top-notch skill acquisition programs. Stay tuned for more details about our facilities, courses, and community impact!</p>
        </div>
      </section>
